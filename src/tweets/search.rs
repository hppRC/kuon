use crate::{Error, PremiumSearchResult, SearchResult, TwitterAPI};
use anyhow::Result;
use std::collections::HashMap;

impl TwitterAPI {
    pub async fn search_tweets(&self, query: &str) -> Result<SearchResult, Error> {
    ...
    pub async fn premium_search_30days(
        ...
        params: &HashMap<&str, &str>,
        devenv_name: &str,
    ) -> Result<PremiumSearchResult, Error> {
        let endpoint = &format!(
